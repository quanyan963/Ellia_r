...
public class ItemLayout extends RelativeLayout {
    ...
    public interface OnSeekBarListener {
        ...
        void onProgressChange(SeekBar seekBar);
    }
    ...
    public ItemLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.ItemLayout_textRight:
                    ...
                    break;
                case R.styleable.ItemLayout_textLeftSecond:
                    strLeftS = a.getString(attr);
                    break;
        ...
        if (TextUtils.isEmpty(strLeftS)) {
            tvLeftSecond.setVisibility(GONE);
        } else {
            tvLeftSecond.setVisibility(VISIBLE);
            tvLeftSecond.setText(strLeftS);
        }
...
//        viewLineBottom.setVisibility(isShowLineBottom ? VISIBLE : GONE);
        ...
        if (seekBar.getVisibility() == VISIBLE) {
            if (sbThumb == null && sbProgressDrawable == null) {
                ...
                seekBar.setProgressDrawable(getResources().getDrawable(R.drawable.seek_bar_black));
            } else {
...
//        viewLineBottom.setVisibility(bottom ? VISIBLE : GONE);
    ...
    public String getTvLeftSecStr() {
        return tvLeftSecond.getText().toString();
    }
    ...
    public void setTvLeftSecStr(String leftSecondStr) {
        if (!leftSecondStr.isEmpty()) {
            tvLeftSecond.setVisibility(VISIBLE);
            tvLeftSecond.setText(leftSecondStr);
        }
    }
    ...
    private void initSeekBarListener(final boolean isOpenSbChange) {
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                mOnSeekBarListener.onProgressChange(seekBar);
            }
