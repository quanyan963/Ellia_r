package com.txtled.ellia_r.model.prefs;
...
public class PreferencesHelperImpl implements PreferencesHelper {
    ...
    public static final String PLAY_STATUE = "play_statue";
    ...
    public void setPlayStatue(int statue) {
        mSharedPreferences.edit().putInt(PLAY_STATUE,statue).apply();
    }

    @Override
    public int getPlayStatue() {
        return mSharedPreferences.getInt(PLAY_STATUE,0);
    }
}
